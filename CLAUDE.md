...
- Run `python3 scripts/render_workflow_tables.py` after changing workflow metadata, help metadata, principles metadata, routing metadata, status metadata, or provider command names
