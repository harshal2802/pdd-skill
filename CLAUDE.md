...
- Run `python3 scripts/render_workflow_tables.py` after changing workflow metadata, Claude skill metadata, help metadata, principles metadata, routing metadata, status metadata, or provider command names
