...
def main() -> None:
    ...
    assert_file(ROOT / "core/metadata/adapter-docs.json", "core/metadata/adapter-docs.json exists")
    assert_file(ROOT / "core/metadata/claude-skill.json", "core/metadata/claude-skill.json exists")
