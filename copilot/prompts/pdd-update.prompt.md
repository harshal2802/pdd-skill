...
If more than half the prompt needs rewriting, suggest starting from scratch with `/pdd-prompts` and moving the old prompt to `pdd/prompts/experiments/` with a date prefix: `YYYY-MM-DD-<descriptive-name>.md`.
