...
### Existing codebase
Search `src/`, `pdd/prompts/features/`, and `pdd/prompts/templates/` for similar functionality.

### Package ecosystem
Search the relevant registry (npm, PyPI, crates.io, pkg.go.dev, etc.) for well-maintained options.
