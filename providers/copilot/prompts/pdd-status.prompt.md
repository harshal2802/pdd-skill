...
<!-- GENERATED:copilot-status-checks:start -->
### 1. Context layer
...
<!-- GENERATED:copilot-status-checks:end -->

## Output format

<!-- GENERATED:copilot-status-output-format:start -->
```text
...
<!-- GENERATED:copilot-status-output-format:end -->
